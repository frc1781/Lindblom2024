...
import tech.team1781.autonomous.routines.TestPathRoutine;
...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    mAutonomousHandler = new AutonomousHandler(mControlSystem, new ExampleRoutine(), new TestPathRoutine());
