...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    mAutonomousHandler = new AutonomousHandler(mControlSystem, new ExampleRoutine(), new PIDTuningRoutine(), new nYOdometryTestRoutine(), new YOdometryTestRoutine(), new XOdometryTestRoutine());
