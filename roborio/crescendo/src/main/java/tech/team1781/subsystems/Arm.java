...
public class Arm extends Subsystem {
    ...
    private ProfiledPIDController mPositionPID = new ProfiledPIDController(0.025, 0, 0.0,
    ...
    private enum CURRENT_AIM_SPOT {
        ...
        SUBWOOFER(34, ConfigMap.RED_SPEAKER_LOCATION, ConfigMap.BLUE_SPEAKER_LOCATION, 2.5), // Was 32.5
        PODIUM(45.0, ConfigMap.RED_PODIUM, ConfigMap.BLUE_PODIUM, 1), // Pos used to be 45
